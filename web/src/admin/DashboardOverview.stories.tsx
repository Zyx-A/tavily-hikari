...
const recentAlerts: RecentAlertsSummary = {
  ...
  countsByType: [
    ...
    { type: 'user_quota_exhausted', count: 5 },
  ],
  topGroups: [
    {
      id: 'group:user_quota_exhausted:user:usr_001:tavily_search',
      ...
      latestEvent: {
        ...
        summary: 'Alice Wang reached the quota ceiling for Tavily Search.',
