...
- `docs/specs/README.md`
  - 新增 `key-impact-maintenance-audit` 索引行。
- `src/lib.rs`
...
- `docs/specs/key-impact-maintenance-audit/contracts/http-apis.md`: 固定管理员/用户日志 DTO 分层边界。
- `docs/specs/key-impact-maintenance-audit/contracts/db.md`: 固定新增字段与维护记录表结构。

## 计划资产（Plan assets）

- Directory: `docs/specs/key-impact-maintenance-audit/assets/`
- In-plan references: `![...](./assets/<file>.png)`
- PR visual evidence source: maintain the single `## Visual Evidence` section when PR screenshots are needed.
