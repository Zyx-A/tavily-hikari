...
- `docs/specs/request-kind-legacy-snapshot-removal/**`
- `src/models.rs`
- `src/store/mod.rs`
...
- `docs/specs/request-kind-canonicalization-lossless-history/SPEC.md`: 标记 legacy 清理已移交 follow-up spec

## 计划资产（Plan assets）

- Directory: `docs/specs/request-kind-legacy-snapshot-removal/assets/`
