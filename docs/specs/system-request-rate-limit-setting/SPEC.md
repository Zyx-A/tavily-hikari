...
- `docs/specs/unified-request-rate-memory-limiter/SPEC.md`: 作为 follow-up 关联，在实现说明或 change log 中保留引用即可（无需直接改写旧 spec 目标）。

## 计划资产（Plan assets）

- Directory: `docs/specs/system-request-rate-limit-setting/assets/`
...
- `docs/specs/unified-request-rate-memory-limiter/SPEC.md`
- `docs/specs/rebalance-mcp-gateway/SPEC.md`
