...
| s2vd2 | 1:1 上游 Credits 计费（MCP + HTTP）                    | 进行中（快车道） | `s2vd2-upstream-credits-billing/SPEC.md`              | 2026-03-06 | fast-flow 复跑：reserved credits 先验阻断、Research success-with-warning 已同步到规格，待新 PR   |
