...
| 9b9w5 | Bun runtime 强制化与 Node 痕迹收口                     | 已完成（6/6）     | `9b9w5-bun-runtime-enforcement/SPEC.md`                    | 2026-03-09 | PR #111 draft ready; Bun runtime enforcement, no-node proof, browser smoke, checks, and review-loop all complete   |
