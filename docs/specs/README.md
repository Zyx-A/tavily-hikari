...
| grzw4 | Web 前端 shadcn/ui 主通路收敛整改                      | 进行中（PR #110） | `grzw4-web-shadcn-mainline-convergence/SPEC.md`            | 2026-03-09 | wrappers + P0/P1 迁移完成；PR #110 checks green；review-loop 无 findings；spec-sync 通过                           |
