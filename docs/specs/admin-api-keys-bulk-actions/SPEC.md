...
- `docs/specs/admin-api-keys-bulk-actions/**`
  - 更新合同、规格与视觉证据。
...
- `docs/specs/admin-api-keys-bulk-actions/contracts/http-apis.md`
- `docs/specs/admin-api-keys-bulk-actions/SPEC.md`

## 计划资产（Plan assets）

- Directory: `docs/specs/admin-api-keys-bulk-actions/assets/`
...
- `docs/specs/admin-api-keys-pagination-url-sync/SPEC.md`
- `docs/specs/admin-api-keys-validation-dialog/SPEC.md`
